		...
		<div class="row align-items-center">
			<div class="col-md-3">
				<a class="navbar-brand" href="../index.jsp"
					style="margin-left: 30px;">ParkMyGadi</a>
			</div>

			<!-- For login and sign up buttons  -->
			<div class="col-md-7 text-end"
				style="padding-right: 0px; padding-left: 0px; margin-right: 0px; margin-left: 115px;">
				...
				<ul class="navbar-nav me-auto mb-2 mb-lg-0"
					...
					<li class="nav-item"><a class="nav-link active"
						aria-current="page" href="home.jsp"><i
							class="fa-solid fa-house"></i> Admin Home</a></li>
